...
/**
 * By using dependency injection, our GreetingLoader can support not only our
 * jest testing environment, but other environments like Storybook, for example.
 */
test('loads greetings on click', async () => {
  // It's recommended sticking with jest.mock
